...
public class GoldAlignDetector extends DogeCVDetector {
    ...
    public double alignSize       = 70;  // How wide is the margin of error for alignment

    public double alignXMax;
    public double alignXMin;
    ...
    public Mat process(Mat input) {
        ...
        alignXMin = alignX - (alignSize / 2); // Min X Pos in pixels
        alignXMax = alignX +(alignSize / 2); // Max X pos in pixels
